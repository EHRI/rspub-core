...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', '**/*test*', 'rspub/core/test/*']
...
htmlhelp_basename = 'rspub-coredoc'
...
man_pages = [
    (master_doc, 'rspub-core', 'rspub-core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rspub-core', 'rspub-core Documentation',
     author, 'rspub-core', 'One line description of project.',
     'Miscellaneous'),
]
